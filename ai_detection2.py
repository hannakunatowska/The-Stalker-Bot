...
from servo_diff_calc import servo_diff
...
def get_tracking_data():
    ...
    return obstacle_detected, person_height_norm
...
if __name__ == "__main__":
    ...
    try:
        while True:
            obstacle, person_height = get_tracking_data()
